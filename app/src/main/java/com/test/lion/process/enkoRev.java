...
public class enkoRev extends AppCompatActivity {
    ...
    String KOR_KEY = "ㄱㄲㄴㄷㄸㄹㅁㅂㅃㅅㅆㅇㅈㅉㅊㅋㅌㅍㅎㅏㅐㅑㅒㅓㅔㅕㅖㅗㅛㅜㅠㅡㅣ";
    String CHO_DATA = "ㄱㄲㄴㄷㄸㄹㅁㅂㅃㅅㅆㅇㅈㅉㅊㅋㅌㅍㅎ";
    String JUNG_DATA = "ㅏㅐㅑㅒㅓㅔㅕㅖㅗㅘㅙㅚㅛㅜㅝㅞㅟㅠㅡㅢㅣ";
    String JONG_DATA = "ㄱㄲㄳㄴㄵㄶㄷㄹㄺㄻㄼㄽㄾㄿㅀㅁㅂㅄㅅㅆㅇㅈㅊㅋㅌㅍㅎ";
    ...
    public String korTypeToEng(String src) {
        ...
        for (int i = 0; i < src.length(); i++) {
            ...
            if (0xac00 <= nCode && nCode <= 0xd7a3) {
                nCode -= 0xac00;
                arrKeyIndex[0] = (int) Math.floor(nCode / (21 * 28));            // 초성
                arrKeyIndex[1] = (int) (Math.floor(nCode / 28) % 21);            // 중성
